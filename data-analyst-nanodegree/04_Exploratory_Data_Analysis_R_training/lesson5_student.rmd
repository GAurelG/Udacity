...
#filter for data !is.na(gender)
gb_1 <- group_by(filter(pf, !is.na(gender)), age, gender)
groups(gb_1)
pf.fc_by_age_gender <- summarise(gb_1,
...
# one day of tenure.
ggplot(aes(x = tenure, y = friendships_initiated/tenure, color = year_joined.bucket),
       data = subset(pf, tenure > 0))+
  geom_line(stat = 'summary', fun.y = mean)

ggplot(aes(x = 7 * round(tenure/7), y = friendships_initiated/tenure, color = year_joined.bucket), data = subset(pf, tenure > 0))+
  geom_line(stat = 'summary', fun.y = mean)

ggplot(aes(x = tenure, y = friendships_initiated/tenure, color = year_joined.bucket), data = subset(pf, tenure > 0))+
  geom_smooth()
